...
public class InputFrameGeneral extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InputFrameGeneral frame = new InputFrameGeneral();
	...
	public InputFrameGeneral() {
		...
		txtpnDdadsdaadd.setText("General job Description 1");
