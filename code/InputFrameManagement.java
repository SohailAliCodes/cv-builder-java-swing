...
public class InputFrameManagement extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InputFrameManagement frame = new InputFrameManagement();
	...
	public InputFrameManagement() {
		...
		textPane_4.setText("Management Job Description 1");
		...
		textPane_5.setText("Job Description 1");
