...
public class InputFrameTech extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InputFrameTech frame = new InputFrameTech();
	...
	public InputFrameTech() {
		...
		textField_15.setBounds(308, 423, 239, 52);
		...
		txtpnDdadsdaadd.setText("Wilson Informatic is looking for Data Science interns");
		...
		txtpnJobDescription.setText("Apex Tech ltd. is hiring Java developers (2-5 year experience)");
		...
		txtpnJobDescription_1.setText("Job opportunity for freshers at Kovair software ltd.");
		...
		JTextPane txtpnBitsnbytesPvtLtd = new JTextPane();
		txtpnBitsnbytesPvtLtd.setToolTipText("");
		txtpnBitsnbytesPvtLtd.setText("BitsnBytes pvt. ltd. is hiring experienced candidates for DBA job role");
		txtpnBitsnbytesPvtLtd.setFont(new Font("Century Gothic", Font.PLAIN, 12));
		txtpnBitsnbytesPvtLtd.setBounds(10, 255, 217, 57);
		panel.add(txtpnBitsnbytesPvtLtd);
		
		JTextPane txtpnDataSceinceInternship = new JTextPane();
		txtpnDataSceinceInternship.setToolTipText("");
		txtpnDataSceinceInternship.setText("Data sceince internship opportunity for freshly graduates");
		txtpnDataSceinceInternship.setFont(new Font("Century Gothic", Font.PLAIN, 12));
		txtpnDataSceinceInternship.setBounds(10, 323, 217, 57);
		panel.add(txtpnDataSceinceInternship);
		
		JTextPane txtpnExperiencedWebDeveloper = new JTextPane();
		txtpnExperiencedWebDeveloper.setToolTipText("");
		txtpnExperiencedWebDeveloper.setText("Experienced web developer needed at GCS");
		txtpnExperiencedWebDeveloper.setFont(new Font("Century Gothic", Font.PLAIN, 12));
		txtpnExperiencedWebDeveloper.setBounds(10, 391, 217, 46);
		panel.add(txtpnExperiencedWebDeveloper);
		
		JTextPane txtpnFullStackDeveloper = new JTextPane();
		txtpnFullStackDeveloper.setToolTipText("");
		txtpnFullStackDeveloper.setText("Full stack developer training and hiring process going on, contact us for details");
		txtpnFullStackDeveloper.setFont(new Font("Century Gothic", Font.PLAIN, 12));
		txtpnFullStackDeveloper.setBounds(10, 448, 217, 56);
		panel.add(txtpnFullStackDeveloper);
